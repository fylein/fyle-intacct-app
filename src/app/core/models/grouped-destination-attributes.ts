...
export type GroupedDestinationAttributes = {
    ...
    CHARGE_CARD_NUMBER?: MappingDestination[];
    ITEM?: MappingDestination[];
    EMPLOYEE?: MappingDestination[];
    ACCOUNT?: MappingDestination[];
    LOCATION_ENTITY?: MappingDestination[];
    CCC_ACCOUNT?: MappingDestination[];
    EXPENSE_PAYMENT_TYPE?: MappingDestination[];
    PAYMENT_ACCOUNT?: MappingDestination[];
