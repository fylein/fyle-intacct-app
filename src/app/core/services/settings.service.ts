...
export class SettingsService {
  ...
  postGeneralSettings(workspaceId: number, reimbursableExpensesObject: string, corporateCreditCardExpensesObject: string, importProjects: boolean, fyleToSageIntacct: boolean, sageIntacctToFyle: boolean, autoMapEmployees: string = null, autoCreateDestinationEntity: boolean) {
